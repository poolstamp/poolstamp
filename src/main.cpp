...
const string strMessageMagic = "poolstamp Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "poolstamp", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "PoolStamp - 30 Nov 2014 Cryptocurrencies spread continue!";
        CTransaction txNew;
        txNew.nTime = 1417362106;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x104596c528e17a16f4b45d288b411a5a11ad75e8267dda2477f01e4ef4b35252"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xb1, 0xb0, 0xb2, 0xb3 };
